...
export class ThreeDSLinkFromCLI implements ThreeDSLinkSender {
    async send3dsx(uri: Uri, ipAddress?: string): Promise<TransferOutcome> {
        return genericSend3dsx(uri, ipAddress);
    }
    async send3dsxWithProgress(uri: Uri, feedback: ProgressFeedback, ipAddress?: string): Promise<TransferOutcome> {
